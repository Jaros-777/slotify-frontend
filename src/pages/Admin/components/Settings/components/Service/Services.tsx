...
export const Services = () => {
    ...
    const handleOpenForm = (id:string | null)=>{
        id !=null ? setSelectedId(id) : setSelectedId(null)
    ...
    return (
        <>
            {showForm ?
                <ServiceForm handleOpenForm={handleOpenForm} id={selectedId}/>
                :
                <div className="flex flex-col items-center h-full">
                    <div className=" bg-white w-full p-6 ">
                        <div className="flex justify-between items-center w-full ">
                            <h1 className="text-3xl font-bold">Services</h1>
                            <button onClick={() => handleOpenForm(null)} className="bg-blue-500 text-white px-6 py-2 rounded-md text-md font-medium cursor-pointer hover:bg-blue-600 duration-200">ADD NEW SERVICE</button>
                        </div>
