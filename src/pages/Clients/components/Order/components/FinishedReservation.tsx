...
export const FinishedReservation = ({ mail, businessName }: reservationProps) => {
    ...
    return (
        <div className="flex flex-col items-center">
            ...
            <div className="flex flex-col items-center border border-gray-300 rounded-md mt-6 py-10 px-2 lg:px-10 w-5/6">
                ...
                <div className="flex mt-10 justify-around w-full">
                    <button
                        className="border border-blue-500 rounded-md px-4 py-2 font-medium text-sm lg:text-md text-blue-500 w-full mr-2 
                        cursor-pointer duration-200 hover:border-blue-900 hover:text-blue-900"
                        onClick={() => alert("This section isn't implemented yet!")}
                    >ADD TO CALENDAR</button>
                    <button
                        className="border border-blue-500 rounded-md px-4 py-2 text-sm lg:font-medium text-blue-500 w-full ml-2 
                        cursor-pointer duration-200 hover:border-blue-900 hover:text-blue-900"
                        onClick={() => alert("This section isn't implemented yet!")}
